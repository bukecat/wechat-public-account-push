  ...
  USERS: [
    {
      ...
      id: "o0dyK5tXKKImb8_jxgto-SuXQaoQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "KOOvluTP5kNTyvvKQYRZ8KwxrYOe5eFMxDmwS6lFQ3Q",
      // 所在省份
      province: "浙江",
      // 所在城市
      city: "杭州",
      ...
      openUrl: "http://inews.gtimg.com/newsapp_bt/0/12921597039/641",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2018-10-18"},
      ]
    },
    {
      // 想要发送的人的名字
      name: "简可",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "o0dyK5nL0bDXhzD6wsArkDMPTSAA",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "KOOvluTP5kNTyvvKQYRZ8KwxrYOe5eFMxDmwS6lFQ3Q",
      // 所在省份
      province: "浙江",
